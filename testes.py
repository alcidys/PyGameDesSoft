...
class PersonagemAnimado:
    def __init__(self, pos_x, pos_y, spritesheet, n_frames):
        ...
        self.virado_para_esquerda = False # Adicionado para controlar a direção
    ...
    def desenhar(self, surface, camera_x=0, x_jogador=None, y_jogador=None):
        ...
        # Inverte o frame horizontalmente se o personagem estiver virado para a esquerda
...
while rodando:
    ...
    # Atualiza a direção do personagem com base na velocidade
    if personagem_escolhido:
        if vel_x < 0:
            personagem_escolhido.virado_para_esquerda = True
        elif vel_x > 0:
            personagem_escolhido.virado_para_esquerda = False
